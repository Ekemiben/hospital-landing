      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {procedures.map((procedure, index) => {
            const Icon = procedure?.icon || FaHospitalSymbol;
            ...
            return (
              ...
              >
                {Icon && (
                  <Icon className="text-4xl text-blue-500 group-hover:text-blue-700 transition-colors duration-300 flex-shrink-0" />
                )}
        ...
        <div className="mt-12 text-center">
          <img
            src="/placeholder-surgical-team.jpg"
            alt="Surgical team performing an operation"
            className="rounded-lg shadow-xl mx-auto w-full max-w-4xl"
          />
          <p className="mt-6 text-lg text-gray-700 max-w-2xl mx-auto">
            Our highly skilled surgical teams perform a wide range of advanced
            procedures using the latest techniques and equipment, ensuring
