        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {specialties.map((service, index) => (
              ...
              >
                <service.icon className="text-5xl text-blue-500 mb-4 group-hover:text-blue-700 transition-colors duration-300" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {otherServices.map((service, index) => (
              ...
              >
                <service.icon className="text-4xl text-green-500 group-hover:text-green-700 transition-colors duration-300 flex-shrink-0" />
                <h4 className="text-xl font-semibold text-gray-800 group-hover:text-blue-800 transition-colors duration-300">
                  {service.name}
                </h4>
              </div>
